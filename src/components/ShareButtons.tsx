...
export default function ShareButtons({ title, url }: ShareButtonsProps) {
  ...
  const links = [
    ...
    // Instagram does not have a native share URL for websites (intent to post a link).
    // The link is provided as a placeholder but traditionally Instagram relies on users copying the link manually
    // or through the native Web Share API on mobile.
  ];
